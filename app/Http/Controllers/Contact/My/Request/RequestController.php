...
namespace App\Http\Controllers\Contact\My\Request;
...
class RequestController extends Controller
{
    ...
    public function index($id)
    {
        ...
        return view('contacts.my.requests.index')
            ->with('account', $contact->AccountId)
            ->with('contact', $id)
            ->with('requests', $requests)
            ->with('total', $requests->total())
            ->with('indexUrl', route('my.contact.requests.index',$id));
    }
    ...
    public function create($id)
    {
        ...
        return view('contacts.my.requests.create')
    ...
    public function edit($id)
    {
        ...
        return view('contacts.my.requests.edit')
            ->with('request', $sr)
            ->with('status', $status)
            ->with('directions', $directions)
            ->with('srTypes', $srTypes)
    ...
    public function history($id)
    {
        ...
        return view('contacts.my.requests.history.index')
            ...
            ->with('requests', $requests)
            ->with('total', $requests->total())
            ->with('indexUrl', route('my.contact.request.history.index', $id));
    }
