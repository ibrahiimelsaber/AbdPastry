...
namespace App\Http\Controllers\Contact\All\Request\Activity;
...
class ActivityController extends Controller
{
    ...
    public function index($id)
    {
        ...
        return view('contacts.all.requests.activities.index')
            ->with('sr', $sr)
            ->with('activities', $activities)
            ->with('total', $activities->total())
            ->with('indexUrl', route('all.contact.request.activities.index', $id));
    }
    ...
    public function create($id)
    {
        ...
        return view('contacts.all.requests.activities.create')
            ->with('sr', $sr)
    ...
    public function edit($id)
    {
        ...
        return view('contacts.all.requests.activities.edit')
