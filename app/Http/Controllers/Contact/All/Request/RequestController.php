...
namespace App\Http\Controllers\Contact\All\Request;
...
class RequestController extends Controller
{
    ...
    public function index($id)
    {
        ...
        return view('contacts.all.requests.index')
            ->with('account', $contact->AccountId)
            ->with('contact', $id)
            ->with('requests', $requests)
            ->with('total', $requests->total())
            ->with('indexUrl', route('all.contact.requests.index',$id));
    }
    ...
    public function create($id)
    {
        ...
        return view('contacts.all.requests.create')
    ...
    public function edit($id)
    {
        ...
        return view('contacts.all.requests.edit')
            ->with('request', $sr)
            ->with('status', $status)
            ->with('directions', $directions)
            ->with('srTypes', $srTypes)
    ...
    public function history($id)
    {
        ...
        return view('contacts.all.requests.history.index')
            ->with('contact', $sr->ContactId)
            ->with('requests', $requests)
            ->with('total', $requests->total())
            ->with('indexUrl', route('all.contact.request.history.index', $id));
    }
