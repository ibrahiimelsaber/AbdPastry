...
namespace App\Http\Controllers\Request\My;
...
class RequestController extends Controller
{
    ...
    {
        $requests = SR::with('contact', 'callDirection', 'type', 'subType', 'subSubType', 'status', 'product', 'subProduct', 'branch', 'complaintType')->where('CreatedBy', '=', session('userName'))->paginate(30);
        return view('requests.my.index')
            ->with('requests', $requests)
            ->with('total', $requests->total())
            ->with('indexUrl', route('my.requests.index'));
    }
    ...
    public function create($id)
    {
        ...
        return view('requests.my.create')
