...
namespace App\Http\Controllers\Request\All\Activity;
...
class ActivityController extends Controller
{
    ...
    public function index($id)
    {
        ...
        return view('requests.all.activities.index')
            ->with('sr', $sr)
    ...
    public function create($id)
    {
        ...
        return view('requests.all.activities.create')
            ->with('sr', $sr)
    ...
    public function edit($id)
    {
        ...
        return view('requests.all.activities.edit')
