...
namespace App\Http\Controllers\Account\My\Phone;
...
class PhoneController extends Controller
{
    ...
    public function index($id)
    {
        ...
        return view('accounts.my.phones.index')
            ->with('phones', $phones)
            ->with('account', $id)
            ->with('total', $phones->total())
            ->with('indexUrl', route('my.account.phones.index', $id));
    }
    ...
    public function create($id)
    {
        ...
        return view('accounts.my.phones.create')
    ...
    public function edit($id)
    {
        ...
        return view('accounts.my.phones.edit')
            ->with('phoneTypes', $phoneTypes)
            ->with('phone', $phone);
