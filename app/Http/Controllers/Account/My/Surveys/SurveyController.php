...
class SurveyController extends Controller
{
    ...
    public function mySurveys()
    {
        ...
        $surveys = Survey::with('account','callStatus')->where('CreatedBy', '=', session('userName'))->orderBy('CreatedOn', 'desc')->paginate(20);

        return view('surveys.my.norm-surveys.index')
            ->with('surveys', $surveys)
            ->with('total', $surveys->total())
            ->with('indexUrl', route('my.surveys.mine'));
    }
    public function index($id)
    {
        ...
        return view('accounts.my.surveys.norm-surveys.index')
            ->with('surveys', $surveys)
            ->with('account', $id)
            ->with('total', $surveys->total())
            ->with('indexUrl', route('my.account.surveys.index', $id));
    }
    ...
    public function create($id)
    {
        ...
        return view('accounts.my.surveys.norm-surveys.create')
