...
namespace App\Http\Controllers\Account\My\Contact\Request\Activity;
...
class ActivityController extends Controller
{
    ...
    public function index($id)
    {
        ...
        return view('accounts.my.contacts.requests.activities.index')
            ->with('sr', $sr)
            ->with('activities', $activities)
            ->with('total', $activities->total())
            ->with('indexUrl', route('my.account.contact.request.activities.index', $id));
    }
    ...
    public function create($id)
    {
        ...
        return view('accounts.my.contacts.requests.activities.create')
            ->with('sr', $sr)
    ...
    public function edit($id)
    {
        ...
        return view('accounts.my.contacts.requests.activities.edit')
