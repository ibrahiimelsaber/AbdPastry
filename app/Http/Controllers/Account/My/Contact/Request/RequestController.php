...
namespace App\Http\Controllers\Account\My\Contact\Request;
...
class RequestController extends Controller
{
    ...
    public function index($id)
    {
        ...
        return view('accounts.my.contacts.requests.index')
            ...
            ->with('indexUrl', route('my.account.contact.requests.index', $id));
    }
    ...
    public function create($id)
    {
        ...
        return view('accounts.my.contacts.requests.create')
    ...
    public function edit($id)
    {
        ...
        return view('accounts.my.contacts.requests.edit')
            ->with('request', $sr)
            ->with('status', $status)
            ->with('directions', $directions)
            ->with('srTypes', $srTypes)
    ...
    public function history($id)
    {
        ...
        return view('accounts.my.contacts.requests.history.index')
            ...
            ->with('requests', $requests)
            ->with('total', $requests->total())
            ->with('indexUrl', route('my.account.contact.request.history.index', $id));
    }
