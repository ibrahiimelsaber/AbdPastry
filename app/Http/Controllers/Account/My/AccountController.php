...
namespace App\Http\Controllers\Account\My;
...
class AccountController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('accounts.my.index')
            ->with('accounts', $accounts)
            ->with('total', $accounts->total())
            ->with('indexUrl', route('my.accounts.index'));
    }
    ...
    public function create()
    {
        ...
        return view('accounts.my.create')
...
//                'PhoneNumber' => 'required|min:10|unique:accounts,PhoneNumber',
            ...
            return redirect()->route('my.accounts.index')->with('message', 'Account is created successfully')->with('class', 'alert-success');
