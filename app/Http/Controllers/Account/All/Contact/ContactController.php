...
namespace App\Http\Controllers\Account\All\Contact;
...
class ContactController extends Controller
{
    ...
    public function index($id)
    {
        ...
        return view('accounts.all.contacts.index')
            ->with('contacts', $contacts)
            ->with('account', $id)
            ->with('total', $contacts->total())
            ->with('indexUrl', route('all.account.contacts.index',$id));
    }
    ...
    public function create(Request $request, $id)
    {
        ...
        return view('accounts.all.contacts.create')
...
//                'PhoneNumber' => 'required|min:10|unique:accounts,PhoneNumber',
    ...
    public function edit($id)
    {
        ...
        return view('accounts.all.contacts.edit')
