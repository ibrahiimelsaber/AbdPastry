...
@section('title','Edit CreatorStudent, '.$creatorStudent->name)

@section('content')
    <section class="section">
        <div class="section-header">
            <h1>Edit CreatorStudent, {{$creatorStudent->name}}</h1>
        </div>
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4>Update CreatorStudent</h4>
                        </div>
                        <div class="card-body">
                            <form method="POST"
                                  action="{{ route('dashboard.creator-students.update',$creatorStudent->id) }}">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <select class="form-control @error('city_id') is-invalid @enderror"
                                            ...
                                            @foreach($cities as $city)
                                                <option {{$city->id==$creatorStudent->city_id?' selected ':''}}
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <select class="form-control @error('university_id') is-invalid @enderror"
                                            ...
                                            @foreach($universities as $university)
                                                <option {{$university->id==$creatorStudent->university_id?' selected ':''}}
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <select class="form-control @error('faculty_id') is-invalid @enderror"
                                            ...
                                            @foreach($faculties as $faculty)
                                                <option {{$faculty->id==$creatorStudent->faculty_id?' selected ':''}}
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" name="name" value="{{old('name',$creatorStudent->name)}}"
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" name="email" value="{{old('email',$creatorStudent->email)}}"
