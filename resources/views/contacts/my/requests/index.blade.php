...
@section('content')
    <section class="section">
        <div class="section-header">
            ...
            <h1 class="ml-2">||</h1>
  <a href="{{route('my.contacts.index')}}"
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-header-action">
                                        ...
                                        <a href="{{route('my.contact.requests.create',$contact)}}"
...
{{--                                                    <td>{{ optional($request->contact)->Id }}</td>--}}
                                                    ...
                                                    <td>
                                                            ...
                                                            <a href="{{route('my.contact.requests.edit',$request->Id)}}"
                                                               class="btn btn-primary"><i class="fa fa-edit"> Update</i>
                                                            </a>

                                                            <a href="{{route('my.contact.request.history.index',$request->Id)}}"
                                                               class="btn btn-info"><i class="fa fa-history"> History</i>
                                                                </a>


                                                            <a href="{{route('my.contact.request.activities.index',$request->Id)}}"
