...
@section('content')
    <section class="section">
        <div class="section-header">
            ...
            <h1 class="ml-2">|| </h1>
            <a href="{{route('my.account.contact.request.activities.index',$activity->request->Id)}}"
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('my.account.contact.request.activities.update', $activity->Id) }}"
