...
@section('content')
    <section class="section">
        <div class="section-header">
            ...
            <h1 class="ml-2">||</h1>
     <a href="{{route('my.account.contact.requests.index',$sr->ContactId)}}"
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-header-action">
                                        ...
                                        <a href="{{route('my.account.contact.request.activities.create',$sr->Id)}}"
                                        ...
                                        <table class="table table-responsive-sm table-hover table-outline">
                                            ...
                                            @foreach($activities as $activity)
                                                <tr>
                                                    ...
                                                    <td>
                                                            <a href="{{route('my.account.contact.request.activities.edit',$activity->Id)}}"
