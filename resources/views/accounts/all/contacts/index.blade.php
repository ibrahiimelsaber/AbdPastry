                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-header-action">
                                        ...
                                        <a href="{{route('all.account.contacts.create',$account)}}"
                                ...
                                <div class="table-responsive table-invoice">
                                            ...
                                            @foreach($contacts as $contact)
                                                <tr>
                                                    ...
                                                    <td>
                                                            ...
                                                            <a href="{{route('all.account.contacts.edit',$contact->Id)}}"
                                                               class="btn btn-primary"><i class="fa fa-edit"> Update Contact</i>
                                                            </a>
                                                            <a href="{{route('all.account.contact.requests.index',$contact->Id)}}"
                                    ...
                                    @else
                                        <div class="text-center p-3 text-muted">
                                            <h5>No Results</h5>
                                            <p>Looks like you have not added any contacts yet!</p>
                                        </div>
                                    @endif
                                </div>
                            </div>
