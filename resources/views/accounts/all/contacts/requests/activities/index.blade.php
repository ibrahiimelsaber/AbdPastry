...
@section('content')
    <section class="section">
        <div class="section-header">
            ...
            <h1 class="ml-2">||</h1>
     <a href="{{route('all.account.contact.requests.index',$sr->ContactId)}}"
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-header-action">
                                        ...
                                        <a href="{{route('all.account.contact.request.activities.create',$sr->Id)}}"
                                ...
                                <div class="table-responsive table-invoice">
                                        ...
                                        <table class="table table-responsive-sm table-hover table-outline">
                                            ...
                                            @foreach($activities as $activity)
                                                <tr>
                                                    ...
                                                    <td>
                                                            <a href="{{route('all.account.contact.request.activities.edit',$activity->Id)}}"
                                    ...
                                    @else
                                        <div class="text-center p-3 text-muted">
                                            <h5>No Results</h5>
                                            <p>Looks like you have not added any activities yet!</p>
                                        </div>
                                    @endif
                                </div>
                            </div>
