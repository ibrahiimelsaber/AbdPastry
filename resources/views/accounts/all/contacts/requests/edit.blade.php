...
@section('content')
    <section class="section">
        <div class="section-header">
            ...
            <h1 class="ml-2">|| </h1>
            <a href="{{route('all.account.contact.requests.index',$request->ContactId)}}"
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('all.account.contact.requests.update') }}"
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#ProductId').on('change', function () {
                ...
                if (ProductId) {
                    $.ajax({
                        url: "{{ url('/getSubProducts') }}"+"/"+ProductId,                        type: "GET",
                        data: {"_token": "{{ csrf_token() }}"},
