...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>Add Activity</h1>
            <h1 class="ml-2">|| </h1>
            <a href="{{route('accounts.contact.requests.activities',$sr->Id)}}"
               class="ml-2 btn btn-primary">Go To Activities</a>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('accounts.contact.requests.activities.store') }}"
